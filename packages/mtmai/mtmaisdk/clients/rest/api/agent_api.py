...
class AgentApi:
    ...
    async def agent_agent_get(
        ...
        _param = self._agent_agent_get_serialize(
            tenant=tenant,
            agent=agent,
    ...
    @validate_call
    async def agent_agent_get_with_http_info(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        agent: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The agent id")],
        _request_timeout: Union[
    ...
    @validate_call
    async def agent_agent_get_without_preload_content(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        agent: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The agent id")],
        _request_timeout: Union[
    ...
    def _agent_agent_get_serialize(
        self,
        tenant,
        agent,
        _request_auth,
    ...
    async def agent_agent_list(
        ...
        _param = self._agent_agent_list_serialize(
            tenant=tenant,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def agent_agent_list_with_http_info(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def agent_agent_list_without_preload_content(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        _request_timeout: Union[
            None,
    ...
    def _agent_agent_list_serialize(
        self,
        tenant,
        _request_auth,
        _content_type,
