...
class AccountApi:
    ...
    @validate_call
    async def account_list_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def account_list_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    async def account_update(
        self,
        update_account_request: Annotated[UpdateAccountRequest, Field(description="The account properties to update")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param update_account_request: The account properties to update (required)
    ...
    @validate_call
    async def account_update_with_http_info(
        self,
        update_account_request: Annotated[UpdateAccountRequest, Field(description="The account properties to update")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def account_update_without_preload_content(
        self,
        update_account_request: Annotated[UpdateAccountRequest, Field(description="The account properties to update")],
        _request_timeout: Union[
            None,
