...
class AgStatesApi:
    ...
    async def ag_state_create(
        ...
        :type tenant: str
        :param ag_state_create: (required)
        :type ag_state_create: AgStateCreate
        ...
        _param = self._ag_state_create_serialize(
            tenant=tenant,
            ag_state_create=ag_state_create,
    ...
    @validate_call
    async def ag_state_create_with_http_info(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        ag_state_create: AgStateCreate,
        _request_timeout: Union[
    ...
    @validate_call
    async def ag_state_create_without_preload_content(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        ag_state_create: AgStateCreate,
        _request_timeout: Union[
    ...
    def _ag_state_create_serialize(
        self,
        tenant,
        ag_state_create,
        _request_auth,
        ...
        if ag_state_create is not None:
            _body_params = ag_state_create
