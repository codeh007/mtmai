...
class AgEventsApi:
    ...
    def _ag_event_create_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/tenants/{tenant}/agEvents',
    ...
    @validate_call
    async def ag_event_get(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        ag_event: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The gallery id")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param tenant: The tenant id (required)
        :type tenant: str
        :param ag_event: The gallery id (required)
        :type ag_event: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._ag_event_get_serialize(
            tenant=tenant,
            ag_event=ag_event,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def ag_event_get_with_http_info(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        ag_event: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The gallery id")],
        _request_timeout: Union[
    ...
    @validate_call
    async def ag_event_get_without_preload_content(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        ag_event: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The gallery id")],
        _request_timeout: Union[
    ...
    def _ag_event_get_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/tenants/{tenant}/agEvents/{agEvent}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def ag_event_list(
        ...
        _param = self._ag_event_list_serialize(
            tenant=tenant,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def ag_event_list_with_http_info(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def ag_event_list_without_preload_content(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        _request_timeout: Union[
            None,
