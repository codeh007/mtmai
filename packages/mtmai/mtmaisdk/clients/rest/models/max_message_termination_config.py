...
class MaxMessageTerminationConfig(BaseModel):
    ...
    max_messages: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["provider", "component_type", "version", "component_version", "description", "label", "config", "termination_type", "max_messages"]
