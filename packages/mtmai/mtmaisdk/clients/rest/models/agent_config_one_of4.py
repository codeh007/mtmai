...
class AgentConfigOneOf4(BaseModel):
    """
    AgentConfigOneOf4
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AgentConfigOneOf4 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentConfigOneOf4 from a dict"""
        if obj is None:
            return None
...
AgentConfigOneOf4.model_rebuild(raise_errors=False)
