...
class BaseModelConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["component_type", "version", "description", "model", "model_type", "api_key", "base_url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BaseModelConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BaseModelConfig from a dict"""
        if obj is None:
            return None
