...
AGENTRUN200RESPONSE_ONE_OF_SCHEMAS = ["AssisantState", "EventBase", "EventTypes", "GenArticleState", "StartWorkflowRunEvent", "TokenChunk"]

class AgentRun200Response(BaseModel):
    """
    AgentRun200Response
    """
    ...
    # data type: EventBase
    oneof_schema_2_validator: Optional[EventBase] = None
    # data type: StartWorkflowRunEvent
    oneof_schema_3_validator: Optional[StartWorkflowRunEvent] = None
    # data type: TokenChunk
    oneof_schema_4_validator: Optional[TokenChunk] = None
    # data type: AssisantState
    oneof_schema_5_validator: Optional[AssisantState] = None
    # data type: GenArticleState
    oneof_schema_6_validator: Optional[GenArticleState] = None
    actual_instance: Optional[Union[AssisantState, EventBase, EventTypes, GenArticleState, StartWorkflowRunEvent, TokenChunk]] = None
    one_of_schemas: Set[str] = { "AssisantState", "EventBase", "EventTypes", "GenArticleState", "StartWorkflowRunEvent", "TokenChunk" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = AgentRun200Response.model_construct()
        error_messages = []
        match = 0
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in AgentRun200Response with oneOf schemas: AssisantState, EventBase, EventTypes, GenArticleState, StartWorkflowRunEvent, TokenChunk. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in AgentRun200Response with oneOf schemas: AssisantState, EventBase, EventTypes, GenArticleState, StartWorkflowRunEvent, TokenChunk. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into AgentRun200Response with oneOf schemas: AssisantState, EventBase, EventTypes, GenArticleState, StartWorkflowRunEvent, TokenChunk. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into AgentRun200Response with oneOf schemas: AssisantState, EventBase, EventTypes, GenArticleState, StartWorkflowRunEvent, TokenChunk. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], AssisantState, EventBase, EventTypes, GenArticleState, StartWorkflowRunEvent, TokenChunk]]:
