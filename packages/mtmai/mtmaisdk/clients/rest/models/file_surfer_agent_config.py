...
class FileSurferAgentConfig(BaseModel):
    """
    ...
    def agent_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['FileSurfer']):
            raise ValueError("must be one of enum values ('FileSurfer')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FileSurferAgentConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FileSurferAgentConfig from a dict"""
        if obj is None:
            return None
...
FileSurferAgentConfig.model_rebuild(raise_errors=False)
