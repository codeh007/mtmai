...
AGENTNODERUNINPUTPARAMS_ONE_OF_SCHEMAS = ["BrowserParams", "CanvasGraphParams", "CrewAIParams", "MessageV2", "ResearchRequest", "ScrapeGraphParams"]
...
class AgentNodeRunInputParams(BaseModel):
    ...
    # data type: MessageV2
    oneof_schema_6_validator: Optional[MessageV2] = None
    actual_instance: Optional[Union[BrowserParams, CanvasGraphParams, CrewAIParams, MessageV2, ResearchRequest, ScrapeGraphParams]] = None
    one_of_schemas: Set[str] = { "BrowserParams", "CanvasGraphParams", "CrewAIParams", "MessageV2", "ResearchRequest", "ScrapeGraphParams" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, CanvasGraphParams):
            ...
            match += 1
        # validate data type: MessageV2
        if not isinstance(v, MessageV2):
            error_messages.append(f"Error! Input type `{type(v)}` is not `MessageV2`")
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in AgentNodeRunInputParams with oneOf schemas: BrowserParams, CanvasGraphParams, CrewAIParams, MessageV2, ResearchRequest, ScrapeGraphParams. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in AgentNodeRunInputParams with oneOf schemas: BrowserParams, CanvasGraphParams, CrewAIParams, MessageV2, ResearchRequest, ScrapeGraphParams. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into MessageV2
        try:
            instance.actual_instance = MessageV2.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into AgentNodeRunInputParams with oneOf schemas: BrowserParams, CanvasGraphParams, CrewAIParams, MessageV2, ResearchRequest, ScrapeGraphParams. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into AgentNodeRunInputParams with oneOf schemas: BrowserParams, CanvasGraphParams, CrewAIParams, MessageV2, ResearchRequest, ScrapeGraphParams. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], BrowserParams, CanvasGraphParams, CrewAIParams, MessageV2, ResearchRequest, ScrapeGraphParams]]:
