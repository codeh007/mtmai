...
class AgentConfigOneOf2(BaseModel):
    """
    AgentConfigOneOf2
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AgentConfigOneOf2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentConfigOneOf2 from a dict"""
        if obj is None:
            return None
...
AgentConfigOneOf2.model_rebuild(raise_errors=False)
