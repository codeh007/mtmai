...
class CodeHighlight(BaseModel):
    ...
    CodeHighlight
    """ # noqa: E501
    start_char_index: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="startCharIndex")
    end_char_index: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="endCharIndex")
