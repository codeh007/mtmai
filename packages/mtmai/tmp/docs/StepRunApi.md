...
async with mtmai.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmai.clients.rest.StepRunApi(api_client)
...
async with mtmai.clients.rest.ApiClient(configuration) as api_client:
    ...
    tenant = 'tenant_example' # str | The tenant id
    step_run = 'step_run_example' # str | The step run id
    rerun_step_run_request = mtmai.clients.rest.RerunStepRunRequest() # RerunStepRunRequest | The input to the rerun
