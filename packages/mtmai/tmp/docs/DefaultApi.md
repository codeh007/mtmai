# mtmaisdk.clients.rest.DefaultApi
...
async with mtmaisdk.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmaisdk.clients.rest.DefaultApi(api_client)
...
async with mtmaisdk.clients.rest.ApiClient(configuration) as api_client:
    ...
    tenant = 'tenant_example' # str | The tenant id
    tenant_invite = 'tenant_invite_example' # str | The tenant invite id
    update_tenant_invite_request = mtmaisdk.clients.rest.UpdateTenantInviteRequest() # UpdateTenantInviteRequest | The tenant invite to update
...
async with mtmaisdk.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmaisdk.clients.rest.DefaultApi(api_client)
    tenant = 'tenant_example' # str | The tenant id
    webhook_worker_create_request = mtmaisdk.clients.rest.WebhookWorkerCreateRequest() # WebhookWorkerCreateRequest |  (optional)
