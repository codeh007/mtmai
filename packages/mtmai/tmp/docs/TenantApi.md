...
async with mtmai.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmai.clients.rest.TenantApi(api_client)
    tenant = 'tenant_example' # str | The tenant id
    create_tenant_alert_email_group_request = mtmai.clients.rest.CreateTenantAlertEmailGroupRequest() # CreateTenantAlertEmailGroupRequest | The tenant alert email group to create
...
async with mtmai.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmai.clients.rest.TenantApi(api_client)
    alert_email_group = 'alert_email_group_example' # str | The tenant alert email group id
    update_tenant_alert_email_group_request = mtmai.clients.rest.UpdateTenantAlertEmailGroupRequest() # UpdateTenantAlertEmailGroupRequest | The tenant alert email group to update
...
async with mtmai.clients.rest.ApiClient(configuration) as api_client:
    ...
    site_host = mtmai.clients.rest.SiteHost() # SiteHost | The tenant properties to update
...
async with mtmai.clients.rest.ApiClient(configuration) as api_client:
    ...
    update_site_request = mtmai.clients.rest.UpdateSiteRequest() # UpdateSiteRequest | The tenant properties to update
...
async with mtmai.clients.rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = mtmai.clients.rest.TenantApi(api_client)
    create_tenant_request = mtmai.clients.rest.CreateTenantRequest() # CreateTenantRequest | The tenant to create
...
async with mtmai.clients.rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = mtmai.clients.rest.TenantApi(api_client)
    accept_invite_request = mtmai.clients.rest.AcceptInviteRequest() # AcceptInviteRequest |  (optional)
...
async with mtmai.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmai.clients.rest.TenantApi(api_client)
    tenant = 'tenant_example' # str | The tenant id
    create_tenant_invite_request = mtmai.clients.rest.CreateTenantInviteRequest() # CreateTenantInviteRequest | The tenant invite to create
...
async with mtmai.clients.rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = mtmai.clients.rest.TenantApi(api_client)
    reject_invite_request = mtmai.clients.rest.RejectInviteRequest() # RejectInviteRequest |  (optional)
...
async with mtmai.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmai.clients.rest.TenantApi(api_client)
    tenant = 'tenant_example' # str | The tenant id
    update_tenant_request = mtmai.clients.rest.UpdateTenantRequest() # UpdateTenantRequest | The tenant properties to update
