# mtmai.gomtmclients.rest.TenantApi
...
async with mtmai.gomtmclients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmai.gomtmclients.rest.TenantApi(api_client)
    tenant = 'tenant_example' # str | The tenant id
    create_tenant_alert_email_group_request = mtmai.gomtmclients.rest.CreateTenantAlertEmailGroupRequest() # CreateTenantAlertEmailGroupRequest | The tenant alert email group to create
...
async with mtmai.gomtmclients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmai.gomtmclients.rest.TenantApi(api_client)
    alert_email_group = 'alert_email_group_example' # str | The tenant alert email group id
    update_tenant_alert_email_group_request = mtmai.gomtmclients.rest.UpdateTenantAlertEmailGroupRequest() # UpdateTenantAlertEmailGroupRequest | The tenant alert email group to update
...
async with mtmai.gomtmclients.rest.ApiClient(configuration) as api_client:
    ...
    site_host = mtmai.gomtmclients.rest.SiteHost() # SiteHost | The tenant properties to update
...
async with mtmai.gomtmclients.rest.ApiClient(configuration) as api_client:
    ...
    update_site_request = mtmai.gomtmclients.rest.UpdateSiteRequest() # UpdateSiteRequest | The tenant properties to update
...
async with mtmai.gomtmclients.rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = mtmai.gomtmclients.rest.TenantApi(api_client)
    create_tenant_request = mtmai.gomtmclients.rest.CreateTenantRequest() # CreateTenantRequest | The tenant to create
...
async with mtmai.gomtmclients.rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = mtmai.gomtmclients.rest.TenantApi(api_client)
    accept_invite_request = mtmai.gomtmclients.rest.AcceptInviteRequest() # AcceptInviteRequest |  (optional)
...
async with mtmai.gomtmclients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmai.gomtmclients.rest.TenantApi(api_client)
    tenant = 'tenant_example' # str | The tenant id
    create_tenant_invite_request = mtmai.gomtmclients.rest.CreateTenantInviteRequest() # CreateTenantInviteRequest | The tenant invite to create
...
async with mtmai.gomtmclients.rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = mtmai.gomtmclients.rest.TenantApi(api_client)
    reject_invite_request = mtmai.gomtmclients.rest.RejectInviteRequest() # RejectInviteRequest |  (optional)
...
async with mtmai.gomtmclients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmai.gomtmclients.rest.TenantApi(api_client)
    tenant = 'tenant_example' # str | The tenant id
    update_tenant_request = mtmai.gomtmclients.rest.UpdateTenantRequest() # UpdateTenantRequest | The tenant properties to update
