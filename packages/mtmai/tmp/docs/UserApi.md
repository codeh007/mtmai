...
async with mtmaisdk.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmaisdk.clients.rest.UserApi(api_client)
...
async with mtmaisdk.clients.rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = mtmaisdk.clients.rest.UserApi(api_client)
    user_register_request = mtmaisdk.clients.rest.UserRegisterRequest() # UserRegisterRequest |  (optional)
...
async with mtmaisdk.clients.rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = mtmaisdk.clients.rest.UserApi(api_client)
    user_login_request = mtmaisdk.clients.rest.UserLoginRequest() # UserLoginRequest |  (optional)
...
async with mtmaisdk.clients.rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = mtmaisdk.clients.rest.UserApi(api_client)
    user_change_password_request = mtmaisdk.clients.rest.UserChangePasswordRequest() # UserChangePasswordRequest |  (optional)
