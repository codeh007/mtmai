# mtmaisdk.clients.rest.EndpointApi
...
async with mtmaisdk.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmaisdk.clients.rest.EndpointApi(api_client)
...
async with mtmaisdk.clients.rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = mtmaisdk.clients.rest.EndpointApi(api_client)
    update_endpoint_request = mtmaisdk.clients.rest.UpdateEndpointRequest() # UpdateEndpointRequest | The tenant properties to update
