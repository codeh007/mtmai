...
async with mtmaisdk.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmaisdk.clients.rest.SNSApi(api_client)
    tenant = 'tenant_example' # str | The tenant id
    create_sns_integration_request = mtmaisdk.clients.rest.CreateSNSIntegrationRequest() # CreateSNSIntegrationRequest |  (optional)
