# mtmai.clients.rest.APITokenApi
...
async with mtmai.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmai.clients.rest.APITokenApi(api_client)
    tenant = 'tenant_example' # str | The tenant id
    create_api_token_request = mtmai.clients.rest.CreateAPITokenRequest() # CreateAPITokenRequest |  (optional)
