# mtmai.clients.rest.PlatformApi
...
async with mtmai.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmai.clients.rest.PlatformApi(api_client)
    platform = mtmai.clients.rest.Platform() # Platform | 
...
async with mtmai.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmai.clients.rest.PlatformApi(api_client)
    platform = 'platform_example' # str | The platform id
    platform2 = mtmai.clients.rest.Platform() # Platform | The platform properties to update
