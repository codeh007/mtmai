...
async with mtmaisdk.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmaisdk.clients.rest.PostApi(api_client)
    tenant = 'tenant_example' # str | The tenant id
    create_post_request = mtmaisdk.clients.rest.CreatePostRequest() # CreatePostRequest | 
