...
async with mtmai.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmai.clients.rest.PostApi(api_client)
    tenant = 'tenant_example' # str | The tenant id
    create_post_request = mtmai.clients.rest.CreatePostRequest() # CreatePostRequest | 
