# mtmai.gomtmclients.rest.SubscribeApi
...
async with mtmai.gomtmclients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmai.gomtmclients.rest.SubscribeApi(api_client)
    tenant = 'tenant_example' # str | The tenant id
    subscribe_request = mtmai.gomtmclients.rest.SubscribeRequest() # SubscribeRequest |  (optional)
