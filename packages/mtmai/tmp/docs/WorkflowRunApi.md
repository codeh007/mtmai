# mtmai.clients.rest.WorkflowRunApi
...
async with mtmai.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmai.clients.rest.WorkflowRunApi(api_client)
    tenant = 'tenant_example' # str | The tenant id
    workflow_runs_cancel_request = mtmai.clients.rest.WorkflowRunsCancelRequest() # WorkflowRunsCancelRequest | The input to cancel the workflow runs
...
async with mtmai.clients.rest.ApiClient(configuration) as api_client:
    ...
    trigger_workflow_run_request = mtmai.clients.rest.TriggerWorkflowRunRequest() # TriggerWorkflowRunRequest | The input to the workflow run
...
async with mtmai.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmai.clients.rest.WorkflowRunApi(api_client)
    tenant = 'tenant_example' # str | The tenant id
    replay_workflow_runs_request = mtmai.clients.rest.ReplayWorkflowRunsRequest() # ReplayWorkflowRunsRequest | The workflow run ids to replay
