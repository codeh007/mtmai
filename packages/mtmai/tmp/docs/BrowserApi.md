...
async with mtmai.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmai.clients.rest.BrowserApi(api_client)
    browser = mtmai.clients.rest.Browser() # Browser | 
...
async with mtmai.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmai.clients.rest.BrowserApi(api_client)
    browser = 'browser_example' # str | The platform id
    browser2 = mtmai.clients.rest.Browser() # Browser | The browser properties to update
