...
async with mtmaisdk.clients.rest.ApiClient(configuration) as api_client:
    ...
    agent_node_create_request = mtmaisdk.clients.rest.AgentNodeCreateRequest() # AgentNodeCreateRequest | 创建agentnode
...
async with mtmaisdk.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmaisdk.clients.rest.AgentApi(api_client)
    tenant = 'tenant_example' # str | The tenant id
    agent_node_run_input = mtmaisdk.clients.rest.AgentNodeRunInput() # AgentNodeRunInput | 创建agentnode
...
async with mtmaisdk.clients.rest.ApiClient(configuration) as api_client:
    ...
    tenant = 'tenant_example' # str | The tenant id
    node = 'node_example' # str | The node id
    agent_node_update_request = mtmaisdk.clients.rest.AgentNodeUpdateRequest() # AgentNodeUpdateRequest | 创建agentnode
