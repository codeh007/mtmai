# mtmai.clients.rest.WorkflowApi
...
async with mtmai.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmai.clients.rest.WorkflowApi(api_client)
    ...
    order_by_field = mtmai.clients.rest.CronWorkflowsOrderByField() # CronWorkflowsOrderByField | The order by field (optional)
    order_by_direction = mtmai.clients.rest.WorkflowRunOrderByDirection() # WorkflowRunOrderByDirection | The order by direction (optional)
...
async with mtmai.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmai.clients.rest.WorkflowApi(api_client)
    tenant = 'tenant_example' # str | The tenant id
    name = mtmai.clients.rest.FlowNames() # FlowNames | The workflow name
...
------------- | ------------- | ------------- | -------------
 **tenant** | **str**| The tenant id | 
 **name** | **FlowNames**| The workflow name | 
...
async with mtmai.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmai.clients.rest.WorkflowApi(api_client)
    workflow = 'workflow_example' # str | The workflow id
    status = mtmai.clients.rest.WorkflowRunStatus() # WorkflowRunStatus | A status of workflow run statuses to filter by (optional)
...
async with mtmai.clients.rest.ApiClient(configuration) as api_client:
    ...
    kinds = [mtmai.clients.rest.WorkflowKind()] # List[WorkflowKind] | A list of workflow kinds to filter by (optional)
    additional_metadata = ['[key1:value1, key2:value2]'] # List[str] | A list of metadata key value pairs to filter by (optional)
    created_after = '2021-01-01T00:00:00Z' # datetime | The time after the workflow run was created (optional)
    created_before = '2021-01-01T00:00:00Z' # datetime | The time before the workflow run was created (optional)
    ...
    order_by_field = mtmai.clients.rest.WorkflowRunOrderByField() # WorkflowRunOrderByField | The order by field (optional)
    order_by_direction = mtmai.clients.rest.WorkflowRunOrderByDirection() # WorkflowRunOrderByDirection | The order by direction (optional)
...
async with mtmai.clients.rest.ApiClient(configuration) as api_client:
    ...
    offset = 56 # int | The number to skip (optional)
    limit = 56 # int | The number to limit by (optional)
    order_by_field = mtmai.clients.rest.ScheduledWorkflowsOrderByField() # ScheduledWorkflowsOrderByField | The order by field (optional)
    order_by_direction = mtmai.clients.rest.WorkflowRunOrderByDirection() # WorkflowRunOrderByDirection | The order by direction (optional)
    workflow_id = 'workflow_id_example' # str | The workflow id to get runs for. (optional)
    parent_workflow_run_id = 'parent_workflow_run_id_example' # str | The parent workflow run id (optional)
    parent_step_run_id = 'parent_step_run_id_example' # str | The parent step run id (optional)
    additional_metadata = ['[key1:value1, key2:value2]'] # List[str] | A list of metadata key value pairs to filter by (optional)
    statuses = [mtmai.clients.rest.ScheduledRunStatus()] # List[ScheduledRunStatus] | A list of scheduled run statuses to filter by (optional)
...
async with mtmai.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmai.clients.rest.WorkflowApi(api_client)
    workflow = 'workflow_example' # str | The workflow id
    workflow_update_request = mtmai.clients.rest.WorkflowUpdateRequest() # WorkflowUpdateRequest | The input to update the workflow
