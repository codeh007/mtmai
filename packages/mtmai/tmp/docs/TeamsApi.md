# mtmaisdk.clients.rest.TeamsApi

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**team_create**](TeamsApi.md#team_create) | **POST** /api/v1/tenants/{tenant}/teams | 
...
# **team_create**
> Team team_create(tenant, team_create)
...
async with mtmaisdk.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmaisdk.clients.rest.TeamsApi(api_client)
    tenant = 'tenant_example' # str | The tenant id
    team_create = mtmaisdk.clients.rest.TeamCreate() # TeamCreate | 

    try:
        api_response = await api_instance.team_create(tenant, team_create)
...
async with mtmaisdk.clients.rest.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.team_list(tenant)
