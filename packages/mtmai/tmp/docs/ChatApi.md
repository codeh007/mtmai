# mtmai.gomtmclients.rest.ChatApi
...
async with mtmai.gomtmclients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmai.gomtmclients.rest.ChatApi(api_client)
...
async with mtmai.gomtmclients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmai.gomtmclients.rest.ChatApi(api_client)
    tenant = 'tenant_example' # str | The tenant id
    chat_req = mtmai.gomtmclients.rest.ChatReq() # ChatReq |  (optional)
...
async with mtmai.gomtmclients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmai.gomtmclients.rest.ChatApi(api_client)
    tenant = 'tenant_example' # str | The tenant id
    chat_completions_req = mtmai.gomtmclients.rest.ChatCompletionsReq() # ChatCompletionsReq |  (optional)
