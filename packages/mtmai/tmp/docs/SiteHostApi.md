# mtmai.clients.rest.SiteHostApi
...
async with mtmai.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmai.clients.rest.SiteHostApi(api_client)
    tenant = 'tenant_example' # str | The tenant id
    create_site_host_request = mtmai.clients.rest.CreateSiteHostRequest() # CreateSiteHostRequest | 创建agentnode
