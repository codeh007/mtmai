# mtmai.gomtmclients.rest.WorkerApi
...
async with mtmai.gomtmclients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmai.gomtmclients.rest.WorkerApi(api_client)
    worker = 'worker_example' # str | The worker id

    try:
        # Get worker
        api_response = await api_instance.worker_get(worker)
        print("The response of WorkerApi->worker_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WorkerApi->worker_get: %s\n" % e)
```
...
|-------------|-------------|------------------|
**200** | Successfully retrieved the worker |  -  |
...
async with mtmai.gomtmclients.rest.ApiClient(configuration) as api_client:
    ...
    try:
        # Get workers
        api_response = await api_instance.worker_list(tenant)
        print("The response of WorkerApi->worker_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WorkerApi->worker_list: %s\n" % e)
```
...
async with mtmai.gomtmclients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmai.gomtmclients.rest.WorkerApi(api_client)
    worker = 'worker_example' # str | The worker id
    update_worker_request = mtmai.gomtmclients.rest.UpdateWorkerRequest() # UpdateWorkerRequest | The worker update

    try:
        # Update worker
        api_response = await api_instance.worker_update(worker, update_worker_request)
        print("The response of WorkerApi->worker_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WorkerApi->worker_update: %s\n" % e)
```
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Successfully updated the worker |  -  |
**400** | A malformed or bad request |  -  |
**403** | Forbidden |  -  |
