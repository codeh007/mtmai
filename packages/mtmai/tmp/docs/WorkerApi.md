...
async with mtmai.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmai.clients.rest.WorkerApi(api_client)
...
async with mtmai.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmai.clients.rest.WorkerApi(api_client)
    worker = 'worker_example' # str | The worker id
    update_worker_request = mtmai.clients.rest.UpdateWorkerRequest() # UpdateWorkerRequest | The worker update
