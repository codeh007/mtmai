# mtmaisdk.clients.rest.WorkerApi
...
async with mtmaisdk.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmaisdk.clients.rest.WorkerApi(api_client)
...
async with mtmaisdk.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmaisdk.clients.rest.WorkerApi(api_client)
    worker = 'worker_example' # str | The worker id
    update_worker_request = mtmaisdk.clients.rest.UpdateWorkerRequest() # UpdateWorkerRequest | The worker update
