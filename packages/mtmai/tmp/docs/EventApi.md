# mtmaisdk.clients.rest.EventApi
...
async with mtmaisdk.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmaisdk.clients.rest.EventApi(api_client)
    tenant = 'tenant_example' # str | The tenant id
    create_event_request = mtmaisdk.clients.rest.CreateEventRequest() # CreateEventRequest | The event to create
...
async with mtmaisdk.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmaisdk.clients.rest.EventApi(api_client)
    tenant = 'tenant_example' # str | The tenant id
    bulk_create_event_request = mtmaisdk.clients.rest.BulkCreateEventRequest() # BulkCreateEventRequest | The events to create
...
async with mtmaisdk.clients.rest.ApiClient(configuration) as api_client:
    ...
    order_by_field = mtmaisdk.clients.rest.EventOrderByField() # EventOrderByField | What to order by (optional)
    order_by_direction = mtmaisdk.clients.rest.EventOrderByDirection() # EventOrderByDirection | The order direction (optional)
...
async with mtmaisdk.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmaisdk.clients.rest.EventApi(api_client)
    tenant = 'tenant_example' # str | The tenant id
    cancel_event_request = mtmaisdk.clients.rest.CancelEventRequest() # CancelEventRequest | The event ids to replay
...
async with mtmaisdk.clients.rest.ApiClient(configuration) as api_client:
    ...
    api_instance = mtmaisdk.clients.rest.EventApi(api_client)
    tenant = 'tenant_example' # str | The tenant id
    replay_event_request = mtmaisdk.clients.rest.ReplayEventRequest() # ReplayEventRequest | The event ids to replay
