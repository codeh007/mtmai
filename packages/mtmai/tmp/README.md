...
*AgStateApi* | [**ag_state_upsert**](docs/AgStateApi.md#ag_state_upsert) | **PATCH** /api/v1/tenants/{tenant}/agStates | 
*AgStatesApi* | [**ag_state_get**](docs/AgStatesApi.md#ag_state_get) | **GET** /api/v1/tenants/{tenant}/agStates/{state} | 
*AgStatesApi* | [**ag_state_list**](docs/AgStatesApi.md#ag_state_list) | **GET** /api/v1/tenants/{tenant}/agStates | 
...
*ChatApi* | [**chat_message_upsert**](docs/ChatApi.md#chat_message_upsert) | **POST** /api/v1/tenants/{tenant}/chat/sessions | 
*ChatApi* | [**chat_messages_list**](docs/ChatApi.md#chat_messages_list) | **GET** /api/v1/tenants/{tenant}/chat/{chat}/messages | 获取聊天消息
*ChatApi* | [**chat_session_get**](docs/ChatApi.md#chat_session_get) | **GET** /api/v1/tenants/{tenant}/chat/sessions/{session} | 获取租户下的聊天列表
*ChatApi* | [**chat_session_list**](docs/ChatApi.md#chat_session_list) | **GET** /api/v1/tenants/{tenant}/chat/sessions | 
...
*TeamApi* | [**team_upsert**](docs/TeamApi.md#team_upsert) | **PATCH** /api/v1/tenants/{tenant}/teams/{team} | 
...
*UiAgentApi* | [**ui_agent_get**](docs/UiAgentApi.md#ui_agent_get) | **GET** /api/v1/tenants/{tenant}/ag_ui | 
...
## Documentation For Models
 ...
 - [AgState](docs/AgState.md)
 - [AgStateList](docs/AgStateList.md)
 - [AgStateProperties](docs/AgStateProperties.md)
 - [AgStateUpsert](docs/AgStateUpsert.md)
 ...
 - [AgentStream200Response](docs/AgentStream200Response.md)
 ...
 - [ChatMessageList](docs/ChatMessageList.md)
 - [ChatMessageRole](docs/ChatMessageRole.md)
 - [ChatMessageUpsert](docs/ChatMessageUpsert.md)
 - [ChatSession](docs/ChatSession.md)
 - [ChatSessionList](docs/ChatSessionList.md)
 - [ChatWelcome](docs/ChatWelcome.md)
 ...
 - [UiAgentConfig](docs/UiAgentConfig.md)
 - [UiAgentState](docs/UiAgentState.md)
