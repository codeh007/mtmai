...
class SelectorManagerState(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "version", "previous_speaker"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['SelectorManagerState']):
            raise ValueError("must be one of enum values ('SelectorManagerState')")
        return value
