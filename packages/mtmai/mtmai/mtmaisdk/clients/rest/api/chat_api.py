...
class ChatApi:
    ...
    async def chat_session_update(
        ...
        _param = self._chat_session_update_serialize(
            tenant=tenant,
            session=session,
    ...
    @validate_call
    async def chat_session_update_with_http_info(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        session: Annotated[StrictStr, Field(description="The session id")],
        chat_session_update: ChatSessionUpdate,
    ...
    @validate_call
    async def chat_session_update_without_preload_content(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        session: Annotated[StrictStr, Field(description="The session id")],
        chat_session_update: ChatSessionUpdate,
    ...
    def _chat_session_update_serialize(
        self,
        tenant,
        session,
        chat_session_update,
