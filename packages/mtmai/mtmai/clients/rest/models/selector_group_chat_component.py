...
class SelectorGroupChatComponent(BaseModel):
    """
    ...
    def provider_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['autogen_agentchat.teams.SelectorGroupChat']):
            raise ValueError("must be one of enum values ('autogen_agentchat.teams.SelectorGroupChat')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "label": obj.get("label"),
            "config": SelectorGroupChatConfig.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
        return _obj
