...
class BaseGroupChatManagerState(BaseModel):
    ...
    message_thread: Optional[List[AgentMessage]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "message_thread": [AgentMessage.from_dict(_item) for _item in obj["message_thread"]] if obj.get("message_thread") is not None else None,
