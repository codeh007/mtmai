...
class SmolaAgentConfig(BaseModel):
    """
    SmolaAgentConfig
    """ # noqa: E501
    name: StrictStr
    ...
    def config_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['smol_agent']):
            raise ValueError("must be one of enum values ('smol_agent')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SmolaAgentConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SmolaAgentConfig from a dict"""
        if obj is None:
            return None
