...
WORKFLOWWORKERSCOUNTOTHER_ANY_OF_SCHEMAS = ["AgentEventType", "AgentTopicTypes", "AgentTypes", "AskUserFunctionCall", "AssistantAgentComponent", "BrowserData", "BrowserOpenTask", "BrowserTask", "ChatSessionStartEvent", "ChatStartInput", "CodeExecutionInput", "CodeExecutionResult", "ComponentModel", "ComponentTypes", "FlowError", "FlowNames", "FlowResult", "FlowTeamInput", "InstagramAgentState", "InstagramTask", "MtOpenAIChatCompletionClientComponent", "MyDemoAgentEvent", "OpenAIClientConfigurationConfigModel", "PlatformAccountData", "PlatformAccountFlowInput", "ProviderTypes", "ResourceFlowInput", "RunFlowModelInput", "SocialAddFollowersInput", "SocialLoginInput", "SocialLoginResult", "SocialTeamConfig", "TeamComponent", "ToolCallRequestEvent", "ToolTypes", "UserAgentState", "UserInputRequestedEvent", "UserTeamConfig"]
...
class WorkflowWorkersCountOther(BaseModel):
    ...
    anyof_schema_11_validator: Optional[PlatformAccountFlowInput] = None
    # data type: AgentEventType
    anyof_schema_12_validator: Optional[AgentEventType] = None
    # data type: ResourceFlowInput
    anyof_schema_13_validator: Optional[ResourceFlowInput] = None
    # data type: InstagramAgentState
    anyof_schema_14_validator: Optional[InstagramAgentState] = None
    # data type: FlowError
    anyof_schema_15_validator: Optional[FlowError] = None
    # data type: SocialTeamConfig
    anyof_schema_16_validator: Optional[SocialTeamConfig] = None
    # data type: SocialAddFollowersInput
    anyof_schema_17_validator: Optional[SocialAddFollowersInput] = None
    # data type: UserAgentState
    anyof_schema_18_validator: Optional[UserAgentState] = None
    # data type: UserTeamConfig
    anyof_schema_19_validator: Optional[UserTeamConfig] = None
    ...
    anyof_schema_25_validator: Optional[AgentTypes] = None
    ...
    anyof_schema_31_validator: Optional[AssistantAgentComponent] = None
    # data type: TeamComponent
    anyof_schema_32_validator: Optional[TeamComponent] = None
    # data type: ComponentModel
    anyof_schema_33_validator: Optional[ComponentModel] = None
    # data type: FlowTeamInput
    anyof_schema_34_validator: Optional[FlowTeamInput] = None
    # data type: ProviderTypes
    anyof_schema_35_validator: Optional[ProviderTypes] = None
    # data type: ComponentTypes
    anyof_schema_36_validator: Optional[ComponentTypes] = None
    # data type: OpenAIClientConfigurationConfigModel
    anyof_schema_37_validator: Optional[OpenAIClientConfigurationConfigModel] = None
    # data type: MtOpenAIChatCompletionClientComponent
    anyof_schema_38_validator: Optional[MtOpenAIChatCompletionClientComponent] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[AgentEventType, AgentTopicTypes, AgentTypes, AskUserFunctionCall, AssistantAgentComponent, BrowserData, BrowserOpenTask, BrowserTask, ChatSessionStartEvent, ChatStartInput, CodeExecutionInput, CodeExecutionResult, ComponentModel, ComponentTypes, FlowError, FlowNames, FlowResult, FlowTeamInput, InstagramAgentState, InstagramTask, MtOpenAIChatCompletionClientComponent, MyDemoAgentEvent, OpenAIClientConfigurationConfigModel, PlatformAccountData, PlatformAccountFlowInput, ProviderTypes, ResourceFlowInput, RunFlowModelInput, SocialAddFollowersInput, SocialLoginInput, SocialLoginResult, SocialTeamConfig, TeamComponent, ToolCallRequestEvent, ToolTypes, UserAgentState, UserInputRequestedEvent, UserTeamConfig]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "AgentEventType", "AgentTopicTypes", "AgentTypes", "AskUserFunctionCall", "AssistantAgentComponent", "BrowserData", "BrowserOpenTask", "BrowserTask", "ChatSessionStartEvent", "ChatStartInput", "CodeExecutionInput", "CodeExecutionResult", "ComponentModel", "ComponentTypes", "FlowError", "FlowNames", "FlowResult", "FlowTeamInput", "InstagramAgentState", "InstagramTask", "MtOpenAIChatCompletionClientComponent", "MyDemoAgentEvent", "OpenAIClientConfigurationConfigModel", "PlatformAccountData", "PlatformAccountFlowInput", "ProviderTypes", "ResourceFlowInput", "RunFlowModelInput", "SocialAddFollowersInput", "SocialLoginInput", "SocialLoginResult", "SocialTeamConfig", "TeamComponent", "ToolCallRequestEvent", "ToolTypes", "UserAgentState", "UserInputRequestedEvent", "UserTeamConfig" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        # validate data type: ComponentModel
        if not isinstance(v, ComponentModel):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ComponentModel`")
        else:
            return v
        ...
        # validate data type: MtOpenAIChatCompletionClientComponent
        if not isinstance(v, MtOpenAIChatCompletionClientComponent):
            error_messages.append(f"Error! Input type `{type(v)}` is not `MtOpenAIChatCompletionClientComponent`")
        else:
            return v

        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in WorkflowWorkersCountOther with anyOf schemas: AgentEventType, AgentTopicTypes, AgentTypes, AskUserFunctionCall, AssistantAgentComponent, BrowserData, BrowserOpenTask, BrowserTask, ChatSessionStartEvent, ChatStartInput, CodeExecutionInput, CodeExecutionResult, ComponentModel, ComponentTypes, FlowError, FlowNames, FlowResult, FlowTeamInput, InstagramAgentState, InstagramTask, MtOpenAIChatCompletionClientComponent, MyDemoAgentEvent, OpenAIClientConfigurationConfigModel, PlatformAccountData, PlatformAccountFlowInput, ProviderTypes, ResourceFlowInput, RunFlowModelInput, SocialAddFollowersInput, SocialLoginInput, SocialLoginResult, SocialTeamConfig, TeamComponent, ToolCallRequestEvent, ToolTypes, UserAgentState, UserInputRequestedEvent, UserTeamConfig. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_33_validator: Optional[ComponentModel] = None
        try:
            instance.actual_instance = ComponentModel.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_34_validator: Optional[FlowTeamInput] = None
        ...
        # anyof_schema_38_validator: Optional[MtOpenAIChatCompletionClientComponent] = None
        try:
            instance.actual_instance = MtOpenAIChatCompletionClientComponent.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into WorkflowWorkersCountOther with anyOf schemas: AgentEventType, AgentTopicTypes, AgentTypes, AskUserFunctionCall, AssistantAgentComponent, BrowserData, BrowserOpenTask, BrowserTask, ChatSessionStartEvent, ChatStartInput, CodeExecutionInput, CodeExecutionResult, ComponentModel, ComponentTypes, FlowError, FlowNames, FlowResult, FlowTeamInput, InstagramAgentState, InstagramTask, MtOpenAIChatCompletionClientComponent, MyDemoAgentEvent, OpenAIClientConfigurationConfigModel, PlatformAccountData, PlatformAccountFlowInput, ProviderTypes, ResourceFlowInput, RunFlowModelInput, SocialAddFollowersInput, SocialLoginInput, SocialLoginResult, SocialTeamConfig, TeamComponent, ToolCallRequestEvent, ToolTypes, UserAgentState, UserInputRequestedEvent, UserTeamConfig. Details: " + ", ".join(error_messages))
        else:
            return instance
