...
class WorkflowWorkersCountOther(BaseModel):
    ...
    # data type: FlowNames
    anyof_schema_21_validator: Optional[FlowNames] = None
    # data type: PlatformAccountFlowInput
    anyof_schema_22_validator: Optional[PlatformAccountFlowInput] = None
    # data type: AgentEventType
    anyof_schema_23_validator: Optional[AgentEventType] = None
    # data type: ResourceFlowInput
    anyof_schema_24_validator: Optional[ResourceFlowInput] = None
    # data type: InstagramAgentState
    anyof_schema_25_validator: Optional[InstagramAgentState] = None
    # data type: IgLoginEvent
    anyof_schema_26_validator: Optional[IgLoginEvent] = None
    # data type: AgentTopicTypes
    anyof_schema_27_validator: Optional[AgentTopicTypes] = None
    # data type: AgentUserInput
    anyof_schema_28_validator: Optional[AgentUserInput] = None
    if TYPE_CHECKING:
