...
class CreateAlbumRequest(BaseModel):
    ...
    CreateAlbumRequest
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True, max_length=100)] = Field(description="The name of the album")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateAlbumRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateAlbumRequest from a dict"""
        if obj is None:
            return None
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in CreateAlbumRequest) in the input: " + _key)
