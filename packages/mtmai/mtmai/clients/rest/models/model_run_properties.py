...
class ModelRunProperties(BaseModel):
    """
    ModelRunProperties
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["llmMessages", "llmResponse"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ModelRunProperties) in the input: " + _key)
