...
class AssistantAgentComponent(BaseModel):
    ...
    def provider_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['mtmai.agents.assistant_agent.AssistantAgent']):
            raise ValueError("must be one of enum values ('mtmai.agents.assistant_agent.AssistantAgent')")
        return value
