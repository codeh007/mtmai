...
class TriggerApi:
    ...
    async def trigger_workflow(
        ...
        :param trigger_workflow_request: (required)
        :type trigger_workflow_request: TriggerWorkflowRequest
        ...
        _param = self._trigger_workflow_serialize(
            trigger_workflow_request=trigger_workflow_request,
    ...
    def _trigger_workflow_serialize(
        ...
        if trigger_workflow_request is not None:
            _body_params = trigger_workflow_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/trigger/workflow',
