...
class ModelRunApi:
    ...
    @validate_call
    async def model_run_get(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        model_run: Annotated[StrictStr, Field(description="The model run id")],
        ...
        _param = self._model_run_get_serialize(
            tenant=tenant,
            model_run=model_run,
    ...
    @validate_call
    async def model_run_get_with_http_info(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        model_run: Annotated[StrictStr, Field(description="The model run id")],
        _request_timeout: Union[
    ...
    @validate_call
    async def model_run_get_without_preload_content(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        model_run: Annotated[StrictStr, Field(description="The model run id")],
        _request_timeout: Union[
    ...
    def _model_run_get_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/tenants/{tenant}/model_runs/{model_run}',
    ...
    async def model_runs_list(
        ...
        _param = self._model_runs_list_serialize(
            tenant=tenant,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def model_runs_list_with_http_info(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def model_runs_list_without_preload_content(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        _request_timeout: Union[
            None,
    ...
    def _model_runs_list_serialize(
        self,
        tenant,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/tenants/{tenant}/model_runs',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
