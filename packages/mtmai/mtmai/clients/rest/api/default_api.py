...
class DefaultApi:
    ...
    @validate_call
    async def dispatcher_listen(
        self,
        worker_id: Annotated[StrictStr, Field(description="The worker id")],
        ...
        :param worker_id: The worker id (required)
        :type worker_id: str
        ...
        _param = self._dispatcher_listen_serialize(
            worker_id=worker_id,
    ...
    @validate_call
    async def dispatcher_listen_with_http_info(
        self,
        worker_id: Annotated[StrictStr, Field(description="The worker id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def dispatcher_listen_without_preload_content(
        self,
        worker_id: Annotated[StrictStr, Field(description="The worker id")],
        _request_timeout: Union[
            None,
    ...
    def _dispatcher_listen_serialize(
        self,
        worker_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/dispatcher/listen/{workerId}',
    ...
    async def workflow_stream(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        run: Annotated[Optional[Annotated[str, Field(min_length=36, strict=True, max_length=36)]], Field(description="The workflow run id")] = None,
        meta: Annotated[Optional[StrictStr], Field(description="query by meta")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param tenant: The tenant id (required)
        :type tenant: str
        :param run: The workflow run id
        :type run: str
        :param meta: query by meta
        :type meta: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._workflow_stream_serialize(
            tenant=tenant,
            run=run,
            meta=meta,
            _request_auth=_request_auth,
    ...
    @validate_call
    async def workflow_stream_with_http_info(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        run: Annotated[Optional[Annotated[str, Field(min_length=36, strict=True, max_length=36)]], Field(description="The workflow run id")] = None,
        meta: Annotated[Optional[StrictStr], Field(description="query by meta")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WorkflowStream200Response]:
        """workflow_stream
    ...
    @validate_call
    async def workflow_stream_without_preload_content(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        run: Annotated[Optional[Annotated[str, Field(min_length=36, strict=True, max_length=36)]], Field(description="The workflow run id")] = None,
        meta: Annotated[Optional[StrictStr], Field(description="query by meta")] = None,
    ...
    def _workflow_stream_serialize(
        self,
        tenant,
        run,
        meta,
