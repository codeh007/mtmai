...
class EventApi:
    ...
    async def event_push(
        ...
        _param = self._event_push_serialize(
            event=event,
    ...
    @validate_call
    async def event_push_with_http_info(
        self,
        event: Event,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def event_push_without_preload_content(
        self,
        event: Event,
        _request_timeout: Union[
            None,
    ...
    def _event_push_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/event/push',
