...
from clients.rest.api_client import ApiClient, RequestSerialized
...
from mtmai.mtmaisdk.rest import RESTResponseType
...
class APITokenApi:
    ...
    def _api_token_create_serialize(
        ...
        _auth_settings: List[str] = ["basicAuth", "cookieAuth", "bearerAuth"]
