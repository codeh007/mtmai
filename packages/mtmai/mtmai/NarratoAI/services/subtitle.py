...
def create_with_gemini(
    audio_file: str, subtitle_file: str = "", api_key: Optional[str] = None
) -> Optional[str]:
    if not api_key:
...
def extract_audio_and_create_subtitle(
    video_file: str, subtitle_file: str = ""
) -> Optional[str]:
    """
    从视频文件中提取音频并生成字幕文件。
...
if __name__ == "__main__":
    ...
    video_file = (
        "/Users/apple/Desktop/home/NarratoAI/resource/videos/merged_video_1702.mp4"
    )
