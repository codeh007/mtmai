...
class Settings(BaseSettings):
  ...
  # 是否是生产环境
  is_production: bool = os.environ.get("MTM_DEV", "development").lower() == "production"
  app_name: str = "Mtmai"
  ...
  MTM_SERVER_URL: str | None = os.environ.get("MTM_SERVER_URL", "http://127.0.0.1:8383")
  # db
  ...
  OPENAI_BASE_URL: str | None = os.environ.get("OPENAI_BASE_URL", "openai_base_url_not_set")
  ...
  def GOOGLE_AI_STUDIO_API_KEY_2(self) -> str | None:
    return os.environ.get("GOOGLE_AI_STUDIO_API_KEY_2", "google_ai_studio_api_key_not_set")
  ...
  def CLOUDFLARE_R2_ENDPOINT(self) -> str | None:
    return os.environ.get("CLOUDFLARE_R2_ENDPOINT", "cloudflare_r2_endpoint_not_set")

  @property
  def CLOUDFLARE_R2_ACCESS_KEY(self) -> str | None:
    return os.environ.get("CLOUDFLARE_R2_ACCESS_KEY", "cloudflare_r2_access_key_not_set")

  @property
  def CLOUDFLARE_R2_SECRET_KEY(self) -> str | None:
    return os.environ.get("CLOUDFLARE_R2_SECRET_KEY", "cloudflare_r2_secret_key_not_set")
