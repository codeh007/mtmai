...
class Agent(Generic[Context]):
    ...
    def __init__(
        ...
        self.browser = (
            browser if browser is not None else (None if browser_context else Browser())
        )
        if browser_context:
    ...
    def _set_tool_calling_method(self) -> Optional[ToolCallingMethod]:
        ...
        if tool_calling_method == "auto":
            if (
                ...
                or self.model_name.startswith("deepseek-ai/deepseek-r1")
            ):
                return "raw"
    ...
    async def step(self, step_info: Optional[AgentStepInfo] = None) -> None:
        ...
        try:
            ...
            try:
                ...
                logger.info(f"browser serive 错误 f{e}")
                raise e
    ...
    async def _handle_step_error(self, error: Exception) -> list[ActionResult]:
        ...
        if isinstance(error, (ValidationError, ValueError)):
            ...
            if isinstance(error, RateLimitError) or isinstance(
    ...
    async def _validate_output(self) -> bool:
        ...
        if self.browser_context.session:
            ...
            msg = [
                ...
                content.get_user_message(self.settings.use_vision),
            ]
        else:
